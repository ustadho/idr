...
import pos.MainForm;
import pos.master.form.MasterSupplier;

/**
 *
 * @author cak-ust
 */
public class FrmListSupplier extends javax.swing.JInternalFrame {
    ...
    private void udfNew() {
        MasterSupplier master=new MasterSupplier(JOptionPane.getFrameForComponent(this), true);
        master.setConn(conn);
...
//        }
    ...
    public void tampilkanData(Integer id, String sCari){
        try {
            ...
            List<Relasi> list=relasiDao.cariSemuaData(SUPPLIER);
            int i=0;
            for(Relasi rel : list){
            ...
            Logger.getLogger(FrmListSupplier.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void udfDelete(){
        ...
        if(iRow<0)
            return;
        try {
            if(JOptionPane.showConfirmDialog(this, "Anda yakin untuk menghapus supplier '"+jTable1.getValueAt(iRow, jTable1.getColumnModel().getColumnIndex("Nama Kota")) +"'", "Hapus Kota", JOptionPane.YES_NO_OPTION)==JOptionPane.NO_OPTION)
                return;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nama Supplier", "Kotak", "Telepon", "Alamat", "Kota"
            }
        ) {
        ...
        jPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 5, 115, -1));
        ...
        jPanel1.add(btnNew, new org.netbeans.lib.awtextra.AbsoluteConstraints(135, 5, 100, -1));
        ...
        jPanel1.add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(495, 5, 105, -1));
        ...
        jPanel1.add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(355, 5, 110, -1));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        menuAuth= new MenuAuthDao(conn).getMenuByUsername("Master Supplier", MainForm.sUserName);
        if(menuAuth!=null){
