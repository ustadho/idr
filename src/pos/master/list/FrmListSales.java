...
import pos.MainForm;
import pos.master.form.MasterSales;
...
public class FrmListSales extends javax.swing.JInternalFrame {
    ...
    private void udfNew() {
        MasterSales master=new MasterSales(JOptionPane.getFrameForComponent(this), true);
        master.setConn(conn);
...
//        }
    ...
    public void tampilkanData(Integer id, String sCari){
        try {
            ...
            List<Sales> list=salesDao.cariSemuaData();
            int i=0;
            for(Sales sales : list){
                ((DefaultTableModel)jTable1.getModel()).addRow(new Object[]{
                    ...
                    sales.getTelp(), 
                    sales.getAlamat(),
                    kotaDao.cariByID(sales.getId_kota()).getNamaKota()
                });
                if(id==sales.getId_sales())
            ...
            Logger.getLogger(FrmListSales.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void udfDelete(){
        ...
        try {
            ...
            salesDao.delete(Integer.parseInt(jTable1.getValueAt(iRow, jTable1.getColumnModel().getColumnIndex("ID")).toString()));
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nama Sales", "Telepon", "Alamat", "Kota"
            }
        ) {
        ...
        jPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(275, 5, 120, -1));
        ...
        jPanel1.add(btnNew, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 5, 100, -1));
        ...
        jPanel1.add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(505, 5, 95, -1));
        ...
        jPanel1.add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 5, 90, -1));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        menuAuth= new MenuAuthDao(conn).getMenuByUsername("Master Salesman", MainForm.sUserName);
        if(menuAuth!=null){
