 ...
 * @author cak-ust
 */
public class FrmListCoa extends javax.swing.JInternalFrame {
     ...
     */
    public FrmListCoa(Connection conn) {
        initComponents();
        this.conn=conn;
    ...
    private void udfNew() {
        MasterCoa master=new MasterCoa(JOptionPane.getFrameForComponent(this), true);
        master.setConn(conn);
    ...
    private void udfEdit() {
        ...
        if(iRow<0)
            return;
        String sAccNo=jTable1.getValueAt(iRow, jTable1.getColumnModel().getColumnIndex("Kode Akun")).toString();
        try {
            MasterCoa master=new MasterCoa(JOptionPane.getFrameForComponent(this), true);
            master.setConn(conn);
            master.setSourceForm(this, sAccNo);
//            master.tampilkanCoa(sAccNo);
            master.setVisible(true);
        } catch (Exception ex) {
...
//        }
    ...
    public void tampilkanData(String accNo, String sCari){
        try {
            ((DefaultTableModel)jTable1.getModel()).setNumRows(0);
            List<AccCoaView> list=dao.cariSemuaCoa(sCari);
            int i=0;
            for(AccCoaView item : list){
                ...
                if(accNo.equalsIgnoreCase(item.getAcc_no())){
            ...
            Logger.getLogger(FrmListCoa.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void udfDelete(){
        ...
        if(iRow<0)
            return;
        try {
            if(JOptionPane.showConfirmDialog(this, "Anda yakin untuk menghapus akun '"+jTable1.getValueAt(iRow, jTable1.getColumnModel().getColumnIndex("Nama Akun")) +"'", "Hapus Akun", JOptionPane.YES_NO_OPTION)==JOptionPane.NO_OPTION)
                return;
            dao.delete(coa);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Akun", "Nama Akun", "Tipe", "Keterangan", "Active"
            }
        ) {
        ...
        jPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 5, 120, -1));
        ...
        jPanel1.add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 5, 80, -1));
        ...
        jPanel1.add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 5, 100, -1));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        menuAuth= new MenuAuthDao(conn).getMenuByUsername("Master Coa", MainForm.sUserName);
        if(menuAuth!=null){
