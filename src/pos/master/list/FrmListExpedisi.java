...
import pos.MainForm;
import pos.master.form.MasterExpedisi;

/**
 *
 * @author cak-ust
 */
public class FrmListExpedisi extends javax.swing.JInternalFrame {
    private Connection conn;
    ExpedisiDao expedisiDao;
    KotaDao kotaDao;
    private GeneralFunction fn=new GeneralFunction();
    /**
     * Creates new form ItemKategori
     */
    public FrmListExpedisi() {
        initComponents();
    ...
    public void initForm(Connection con){
        ...
        expedisiDao=new ExpedisiDao(conn);
    ...
    private void udfNew() {
        MasterExpedisi master=new MasterExpedisi(JOptionPane.getFrameForComponent(this), true);
        master.setConn(conn);
...
//        }
    ...
    public void tampilkanData(Integer id, String sCari){
        try {
            ...
            //List<Expedisi> list=expedisiDao.cariSemuaData();
            List<Expedisi> list=expedisiDao.filterSemuaData(sCari);
            int i=0;
            for(Expedisi supp : list){
                ((DefaultTableModel)jTable1.getModel()).addRow(new Object[]{
                    supp.getNama_expedisi(),
                    supp.getKontak(), 
                    supp.getTelp(), 
                    supp.getAlamat(),
                    kotaDao.cariByID(supp.getId_kota()).getNamaKota(),
                    supp.getId(),
            ...
            Logger.getLogger(FrmListExpedisi.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void udfDelete(){
        ...
        try {
            ...
            expedisiDao.delete(Integer.parseInt(jTable1.getValueAt(iRow, jTable1.getColumnModel().getColumnIndex("ID")).toString()));
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama Expedisi", "Kotak", "Telepon", "Alamat", "Kota", "ID"
            }
        ) {
        ...
        jPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(305, 5, 120, -1));
        ...
        jPanel1.add(btnNew, new org.netbeans.lib.awtextra.AbsoluteConstraints(205, 5, 100, -1));
        ...
        jPanel1.add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 5, 90, -1));
        ...
        jPanel1.add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(425, 5, 90, -1));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        menuAuth= new MenuAuthDao(conn).getMenuByUsername("Master Expedisi", MainForm.sUserName);
        if(menuAuth!=null){
