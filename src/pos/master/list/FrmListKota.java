...
import pos.MainForm;
import pos.master.form.MasterKota;

/**
 *
 * @author cak-ust
 */
public class FrmListKota extends javax.swing.JInternalFrame {
     ...
     */
    public FrmListKota(Connection conn) {
        initComponents();
        this.conn=conn;
    ...
    private void udfNew() {
        MasterKota master=new MasterKota(JOptionPane.getFrameForComponent(this), true);
        master.setConn(conn);
    ...
    private void udfEdit() {
        ...
        try {
            ...
            master.setConn(conn);
            master.setSourceForm(this);
            master.tampilkanKota(dao.cariByID(id));
            master.setVisible(true);
        } catch (Exception ex) {
...
//        }
    ...
    public void tampilkanData(Integer id, String sCari){
        try {
            ...
            List<Kota> list=dao.FilterKota(sCari);
            int i=0;
            for(Kota kota : list){
                ((DefaultTableModel)jTable1.getModel()).addRow(new Object[]{
                    ...
                    kota.getProvinsi(),
                    kota.getNegara(),
                    kota.getIdArea()==null? "": areaDao.cariByID(kota.getIdArea()).getNama()
                });
                if(id==kota.getId()){
            ...
            Logger.getLogger(FrmListKota.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void udfDelete(){
        ...
        try {
            ...
            dao.delete(Integer.parseInt(jTable1.getValueAt(iRow, jTable1.getColumnModel().getColumnIndex("ID")).toString()));
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nama Kota", "Provinsi", "Negara", "Area"
            }
        ) {
        ...
        jPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(275, 5, 130, -1));

        btnNew.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/images/add.png"))); // NOI18N
        btnNew.setText("New (F2)");
        ...
        jPanel1.add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(405, 5, 90, -1));
