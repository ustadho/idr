 ...
 * @author cak-ust
 */
public class FrmListSatuan extends javax.swing.JInternalFrame {
        ...
        jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if(iRow<0 || dao==null)
                    return;
                try {
                    satuan=dao.cariSatuanByID((Integer)jTable1.getValueAt(iRow, jTable1.getColumnModel().getColumnIndex("ID")));
                    if(satuan!=null){
                        lblID.setText(satuan.getId().toString());
                        txtNama.setText(satuan.getSatuan());
                        txtKet.setText(satuan.getKeterangan());
                    }
                    
                } catch (Exception ex) {
                    Logger.getLogger(FrmListSatuan.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
        tampilkanData(0);
    ...
    private void tampilkanData(Integer id){
        try {
            ...
            List<Satuan> list=dao.cariSemuaData();
            int i=0;
            for(Satuan item : list){
    ...
    private void udfSave() {
        ...
        try {
            ...
            s.setId(id);
            s.setSatuan(txtNama.getText());
            s.setKeterangan(txtKet.getText());
            dao.simpan(s);
            tampilkanData(id);
        } catch (Exception ex) {
...
//        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(135, 90, 85, -1));
        ...
        jPanel1.add(btnNew, new org.netbeans.lib.awtextra.AbsoluteConstraints(55, 90, 80, -1));
        ...
        jPanel1.add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(305, 90, 80, -1));
        ...
        jPanel1.add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 90, 85, -1));
