 ...
 * @author cak-ust
 */
public class FrmArReceiptHis extends javax.swing.JInternalFrame {
    ...
    public void udfLoadData(String arNo){
        String sQry="select * from fn_ar_receipt_list("
                + "'"+GeneralFunction.yyyymmdd_format.format(jXDatePicker1.getDate())+"', "
                + "'"+GeneralFunction.yyyymmdd_format.format(jXDatePicker2.getDate())+"', "
                + "'"+txtCari.getText()+"') as (ar_no varchar, tanggal date, nama_customer varchar, \n" +
                "check_amount double precision, no_bukti varchar, keterangan text, acc_name varchar, "
                + "alat_bayar varchar, tgl_cek date, no_penjualan text) ";
        ...
        try{
            ...
            while(rs.next()){
                ((DefaultTableModel)tblHeader.getModel()).addRow(new Object[]{
                    ...
                    rs.getString("alat_bayar"),    //8
                    rs.getDate("tgl_cek"), //9
                    rs.getString("no_penjualan"),    //10
    ...
    private void initComponents() {
        ...
        tblHeader.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No. Trx", "Tanggal", "Pelanggan", "Total Pembayaran", "Keterangan", "Akun", "Alat Bayar", "No. Bukti", "Tgl. Cek/ Giro", "No. Penjualan"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.Double.class, java.lang.Object.class, java.lang.Double.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class
            };
...
//            param.put("SUBREPORT_DIR", sSubRpt);
    ...
    private void udfNew() {
        FrmArReceipt f1=new FrmArReceipt();
        f1.setConn(conn);
        MainForm.jDesktopImage2
                .add(f1, JLayeredPane.DEFAULT_LAYER);
        f1.setSrcForm(aThis);
        f1.setKoreksi(false);
        f1.setVisible(true);
    }
