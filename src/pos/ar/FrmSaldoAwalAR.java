...
import pos.MainForm;
import pos.dialog.DlgSaldoAwalAr;

/**
 *
 * @author cak-ust
 */
public class FrmSaldoAwalAR extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Saldo Awal Piutang Pelanggan");
        ...
        jLabel7.setText("Saldo Awal Piutang Penjualan");
        ...
        txtCustomer.setBounds(106, 14, 90, 20);
        ...
        jPanel2.add(txtNamaCustomer);
        txtNamaCustomer.setBounds(202, 14, 367, 20);
        ...
        tblDetail.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No. Invoice", "Tanggal", "Jth. Tempo", "Jumlah", "Terbayar", "Sales", "ID"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class, java.lang.Integer.class
            };
    ...
    private void txtCustomerKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCustomerKeyReleased
        fn.lookup(evt, new Object[]{txtNamaCustomer, txtTop},
    ...
    public void loadDetail(Integer arId){
        this.arId=arId;
        String sql="select id_customer, coalesce(c.nama_relasi,'') as nama, coalesce(c.top,0) as top\n" +
        "from ar_inv h \n" +
    ...
    private void udfNew() {
        DlgSaldoAwalAr d1=new DlgSaldoAwalAr(JOptionPane.getFrameForComponent(this), true);
        d1.setTitle("Tambah Saldo Awal Piutang");
        d1.setRelasi(GeneralFunction.udfGetInt(txtCustomer.getText()), txtNamaCustomer.getText(), fn.udfGetInt(txtTop.getText()));
    ...
    public void udfLoadSaldoAwal(){
        String sql="select id, invoice_no, h.invoice_date, h.top, h.invoice_date+h.top as jth_tempo, h.invoice_amount, h.paid_amount , coalesce(s.nama_sales,'') as nama_sales\n" +
                    "from ar_inv h \n" +
                    "left join m_salesman s on s.id_sales=h.id_sales\n" +
                    "where trx_type ='SAR'\n" +
                    "and id_customer="+txtCustomer.getText()+" "
                + "order by id";
        System.out.println(sql);
        try {
            ((DefaultTableModel)tblDetail.getModel()).setNumRows(0);
            if(txtCustomer.getText().trim().equalsIgnoreCase(""))
                return;
            ...
            while(rs.next()){
                ...
                if(arId !=null && rs.getInt("id")==arId){
    ...
    private void udfEdit() {
        ...
        d1.setConn(conn);
        d1.setSrcForm(this);
        d1.setArId((Integer)tblDetail.getValueAt(row, tblDetail.getColumnModel().getColumnIndex("ID")));
        d1.setVisible(true);
    }
