...
import com.ustasoft.pos.dao.jdbc.SoDao;
 ...
 * @author cak-ust
 */
public class FrmSO extends javax.swing.JInternalFrame {
...
//        
    ...
    private boolean udfCekBeforeSave(){
        ...
        if(txtCustomer.getText().trim().length()==0){
            JOptionPane.showMessageDialog(this, "Silahkan pilih customer terlebih dulu!");
    ...
    private void udfSave(){
        ...
        try{
            ...
            header.setSupplierId(Integer.parseInt(txtCustomer.getText()));
            ...
            header.setSoDisc(txtDisc.getText());
            ...
            soDao.simpanHeader(header);
            sNoSo=header.getNoSo();
            txtNoSo.setText(sNoSo);
            header.setNoSo(sNoSo);
            
            List<SODet> detail=new ArrayList<SODet>();
            TableColumnModel col=tblDetail.getColumnModel();

            for(int i=0; i<tblDetail.getRowCount(); i++){
                SODet det=new SODet();
                det.setNoSo(txtNoSo.getText());
            ...
            soDao.simpanSODetail(detail, txtNoSo.getText().equalsIgnoreCase(""));
            sNoSo= header.getNoSo();
            
            conn.setAutoCommit(true);
            if(srcForm!=null){
                if(srcForm instanceof FrmSOHis){
                    if(!isNew)
                        {((FrmSOHis)srcForm).udfRefreshDataPerBaris(header.getNoSo());}
                    else
                        {((FrmSOHis)srcForm).udfLoadData(header.getNoSo());}
                }
            }
            JOptionPane.showMessageDialog(this, isNew? "Data PO tersimpan dengan nomor '"+sNoSo+"'!": "Update PO Sukses!");
    ...
    private void initComponents() {
        ...
        txtNoSo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtNoSoActionPerformed(evt);
            }
        });
        jPanel1.add(txtNoSo, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 170, 20));

        lblCustomer.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jPanel1.add(lblCustomer, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 35, 520, 20));
        ...
        jPanel1.add(txtCustomer, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 35, 60, 20));
        ...
        jPanel1.add(lblAlamat, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 60, 580, 20));
        ...
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 85, 90, 20));

        cmbSales.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanel1.add(cmbSales, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 85, 260, 20));
        ...
        jLabel6.setText("  Pesanan Penjualan (SO)");
        ...
        setBounds((screenSize.width-867)/2, (screenSize.height-546)/2, 867, 546);
    ...
    private void txtCustomerKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCustomerKeyReleased
        String sQry="select id_relasi::varchar as id_customer, coalesce(nama_relasi,'') as nama_customer, "
                ...
                + "where tipe_relasi=0 and id_relasi::varchar||coalesce(nama_relasi,'')||alamat||' - '||kota.nama_kota "
    ...
    private void txtNoSoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNoSoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtNoSoActionPerformed
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        new ReportService(conn, aThis).cetakSO(param);
    ...
    public void tampilkanData(String id) {
        try {
            String sQry="select h.no_po, h.tanggal, h.customer_id, coalesce(s.nama_relasi,'') as nama_customer, "
    ...
    public void setNoSo(String sNoSo) {
        sNoSo=sNoSo;
    }
