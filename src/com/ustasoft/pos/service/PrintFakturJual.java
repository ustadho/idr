 ...
 * @author cak-ust
 */
public class PrintFakturJual {

    private Connection conn;
    PrintESC printESC = new PrintESC();

    public PrintFakturJual(Connection c, Integer id, String userName, PrintService service) {
        try {
            this.conn = c;
            ...
            Logger.getLogger(PrintFakturJual.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//            temp.deleteOnExit();
            ...
            while(rs.next()){
                if(i==0){
                    ...
                    out.write(printESC.padString(MainForm.sAlamat2, 70)+                              "+------------------------------------------+");  out.newLine();
...
// It is now safe to close the input stream
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            PrintFakturJual pn = new PrintFakturJual(conn, 2, "admin", services[4]);
